        ...
        <View style={styles.container}>
            ...
            <View style={styles.backgroundContainer}>
                ...
                <View style={styles.submitButton}>
                    <View >
                        <Button onPress={registerVaccine} buttonColor='rgb(73, 185, 118)' textColor='white' mode='elevated'>Salvar</Button>
                    </View>
                    <View >
                        <Button onPress={deleteVaccine} buttonColor='rgb(73, 185, 118)' textColor='white' mode='elevated'>Excluir</Button>
                    </View>
                </View>
            </View>
